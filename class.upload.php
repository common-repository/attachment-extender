 ...
 *   - added support for Flash uploaders (experimental). Beware that using Flash uploaders creates a security risk as you can't check the MIME type</li>
 * <ul> 
        ...
        if (!is_array($file)) {
            ...
            if ($this->uploaded) {
                ...
                if ($this->file_src_mime == 'application/octet-stream') {
                    $this->log .= '- Flash rewrites MIME as application/octet-stream<br />';
                    $this->log .= '  file extension is ' . $this->file_src_name_ext . ', ';
                    ...
                    if ($this->file_src_mime == 'application/octet-stream') {
                        $this->log .= 'and doesn\t look like it is an image<br />';
                    } else {
    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
				// changed to fit wordpresses structure
